 ...
 * Implemented choice: **Monsieur Iso** (house savant; ISO as a wink to exposure culture).
 */
export const AI_BRAND = {
  ...
  welcomeMessage:
    "Bonjour—I’m **Monsieur Iso**. Ask in any language: vibe, budget, brand, or use case. I only suggest bodies we actually hold in stock—no phantom SKUs.",
  /** When GEMINI_API_KEY is missing */
  geminiRestingMessage:
    "Monsieur Iso is resting—add GEMINI_API_KEY for live wit in any language. Until then, browse the shop or write us from Contact.",
  /** Floating launcher (short) */
  chatButtonLabel: "Monsieur Iso",
  chatButtonTeaser: "Ask the house savant",
  chatAriaLabel: "Open Monsieur Iso chat",
  panelEyebrow: "Edogawa Vintage",
  panelTitle: "Monsieur Iso",
  ...
  /** Homepage / marketing */
  marketingHeadline: "Meet Monsieur Iso",
  marketingSubhead:
